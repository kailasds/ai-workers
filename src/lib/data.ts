    ...
    sections: [
      {
        ...
        requirements: [
          { id: "r1", label: "Business rules extracted", status: "passed", evidence: ["42 business rules extracted"] },
          { id: "r2", label: "Rules traceable to source", status: "passed", evidence: ["42 mapped to Java implementation"] },
          { id: "r3", label: "Expected behavior reproduced", status: "passed", evidence: ["Validation run #324 completed"] },
          { id: "r4", label: "Data behavior reconciled", status: "pending", evidence: [] },
        ],
      },
      {
        id: "dod-2",
        title: "Validation",
        requirements: [
          { id: "r5", label: "Unit tests passed", status: "passed", evidence: ["312 / 312 unit tests passed"] },
          { id: "r6", label: "Integration tests passed", status: "passed", evidence: ["48 / 48 integration tests passed"] },
          { id: "r7", label: "Regression checks passed", status: "pending", evidence: [] },
          { id: "r8", label: "Representative production scenarios replayed", status: "pending", evidence: [] },
        ],
      },
      {
        id: "dod-3",
        title: "Code Quality",
        requirements: [
          { id: "r9", label: "Static analysis passed", status: "passed", evidence: ["SonarQube scan completed, 0 new high severity findings"] },
          { id: "r10", label: "No high severity security issues", status: "passed", evidence: ["Security scan #118 — clean"] },
          { id: "r11", label: "Code review completed", status: "pending", evidence: [] },
        ],
      },
      {
        id: "dod-4",
        ...
        requirements: [
          { id: "r12", label: "Record counts reconciled", status: "pending", evidence: [] },
          { id: "r13", label: "Checksums validated", status: "pending", evidence: [] },
          { id: "r14", label: "Field precision preserved", status: "pending", evidence: [] },
        ],
      },
      {
        id: "dod-5",
        title: "Governance",
        requirements: [
          { id: "r15", label: "Policy checks passed", status: "passed", evidence: ["12 policies evaluated, 12 compliant"] },
          { id: "r16", label: "Required evidence attached", status: "passed", evidence: ["48 evidence items attached"] },
          { id: "r17", label: "Required approvals received", status: "pending", evidence: [] },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        requirements: [
          { id: "r1", label: "API contract honored", status: "passed", evidence: ["Contract test suite passed"] },
          { id: "r2", label: "Backend implementation complete", status: "passed", evidence: ["12 endpoints implemented"] },
          { id: "r3", label: "Frontend implementation complete", status: "pending", evidence: [] },
        ],
      },
      {
        id: "dod-2",
        title: "Validation",
        requirements: [
          { id: "r4", label: "Tests passed", status: "passed", evidence: ["84 / 84 unit tests passed"] },
          { id: "r5", label: "No regression", status: "pending", evidence: [] },
        ],
      },
      {
        id: "dod-3",
        ...
        requirements: [
          { id: "r6", label: "Security scans passed", status: "passed", evidence: ["Dependency scan clean"] },
          { id: "r7", label: "Code review completed", status: "pending", evidence: [] },
        ],
      },
      {
        id: "dod-4",
        title: "Release",
        requirements: [
          { id: "r8", label: "Pull request approved", status: "pending", evidence: [] },
          { id: "r9", label: "Evidence attached", status: "passed", evidence: ["Evidence bundle #41 attached"] },
        ],
      },
    ],
  },
...
function stubWorker(
  ...
  return {
    ...
    scope: { primaryPurpose: `${role} operations for ${domain}.`, boundedScope: "Not yet configured.", expectedOutcome: "Not yet configured.", outOfScope: [] },
